...
{
    public class MasterAbpDataSeedContributor : IDataSeedContributor, ITransientDependency
    {
        private readonly IRepository<Category, Guid> _categoryRepository;
        private readonly IRepository<Product, Guid> _productRepository;

        public MasterAbpDataSeedContributor(IRepository<Category, Guid> categoryRepository,
